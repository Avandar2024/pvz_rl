...
使用CNN提取2D空间特征的Double DQN

用法:
    python train_cnn_ddqn.py --episodes 100000 --name cnn_ddqn_test
    python train_cnn_ddqn.py --episodes 50000 --name test --env v3 --channels 64
"""

import gymnasium as gym
from agents.cnn_ddqn_agent import experienceReplayBuffer, CNN_DDQNAgent, CNNQNetwork
import torch
import argparse
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="CNN-DDQN Training")
